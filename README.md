# [XtBot Rosinxt T V.s](https://telegram.me/roboxt/rosinXT)
...
#کد نصب بوت
cd $HOME
git clone https://github.com/robosaz/rosinxt.git
cd rosinxt
chmod +x launch.sh
./launch.sh install
./launch.sh
...
##  ** نـمـــونــہ ربــاتـــ **
# [Robo](https://telegram.me/RoboXT)

## ℵ✞ گروه تلگرام  ℵт
# [پشتیبانی](https://telegram.me/robo_xt)

# [سایت سوالات و مشکلات](https://botchi.ir)

# [pm Telegram](https://t.me/shahin_xtbot)
